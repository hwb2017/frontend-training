				...
				<div class="r-list-wrapper" ref="listWrapper">
					...
					<ul class="r-list-live">
						<div class="mini-preview-wrapper">
							<div class="mini-preview-list-wrapper">
								<ul class="mini-preview" ref="miniPreview">
									<li class="preview" v-for="(pre,index) in preview" :key="index">
							...
							<div class="s-bottom">
								<div class="info">
									<div class="info-item"  v-for="(pre, index) in preview" :class="{ show: count == index,hide: count !== index }" :key="index">
										<a class="t" :href="pre.url" :title="pre.title" target="_blank">{{pre.title}}</a>
									</div>
								</div>
								<ul class="slider-bar">
									<li bar :class="{on: count == index}" v-for="(item, index) in preview" @mouseover="cutItem(index)" :key="index">
										<a></a>
									</li>
								</ul>
							</div>
						...
						<div class="live-pmt-live">
							<li v-for="(anchor,index) in recommendAnchor" :key="index">
