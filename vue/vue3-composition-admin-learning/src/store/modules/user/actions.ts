...
import { useStore, ActionContext, ActionTree } from 'vuex'
...
} & Omit<ActionContext<UserState, ObjectConstructor>, 'commit'>
...
export const actions: ActionTree<UserState, ObjectConstructor> & Actions = {
